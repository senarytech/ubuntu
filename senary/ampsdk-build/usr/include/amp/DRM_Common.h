...
void MV_DRM_TraceHex(const char* pszModuleName,
                       const char* pszFuncName,
                       UINT uLevel,
                       const UCHAR* pbData, UINT32 uSize );
#ifdef NO_RPC
...
#define MARLIN_AGENT_LEVEL1     "MARLINAGENT ",     __FUNCTION__,  1,
#define MARLIN_SERVER_LEVEL1    "MARLINSERVER ",    __FUNCTION__,  1,
#define MARLIN_SERVER_LEVEL2    "MARLINSERVER ",    __FUNCTION__,  2,
#define MARLIN_PACK_LEVEL       "MARLINDEC ",       __FUNCTION__,  5,
...
#define MARLIN_AGENT_DEBUG    MV_DRM_DebugTrace
#define MARLIN_AGENT_ERROR    MV_DRM_ErrorTrace
...
#define MARLIN_SERVER_DEBUG     MV_DRM_DebugTrace
#define MARLIN_SERVER_ERROR     MV_DRM_ErrorTrace
#define MARLIN_SERVER_TRACEHEX  MV_DRM_TraceHex
...
#define MARLIN_AGENT_DEBUG(...)
#define MARLIN_AGENT_ERROR(...)
...
#define MARLIN_SERVER_DEBUG(...)
#define MARLIN_SERVER_ERROR(...)
#define MARLIN_SERVER_TRACEHEX(...)
...
#define TKLDRM_CTX_MAGIC_ID         VMXDRM_CTX_MAGIC_ID
...
#if CONFIG_NEW_SECSTORE
#define NEW_SECURE_STORE
#endif

#if CONFIG_ENABLE_PLAYREADY
#define enable_playready    1
#endif

#if CONFIG_ENABLE_PRFIGOFW
