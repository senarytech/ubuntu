/*------------------------------------------------------------------------------
  ...
  Modification ID : 03e95bfeb910b454772d71d7172ca87e80bdcd01
------------------------------------------------------------------------------*/
/**
 @file    sony_demod.h
...
typedef enum {
    ...
    */
    ...
    /**
     @brief Single cable switch inverts spectrum or not.

            Value:
            - 0: Not invert type switch.
            - 1: Invert type switch. (Default)
    */
    SONY_DEMOD_CONFIG_SAT_SINGLECABLE_SPECTRUM_INV,
    ...
    */
    ...
    /**
     @brief Disable/Enable TLVVALID during TLV NULL packets replaced by demodulator.
    ...
    */
    SONY_DEMOD_CONFIG_TLVVALID_MASK_IN_NULL,
