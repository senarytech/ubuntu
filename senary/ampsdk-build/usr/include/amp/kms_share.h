...
#ifndef __KMS_SHARE_H__
#define __KMS_SHARE_H__
#include <curl/curl.h>
//#include <curl/types.h>
#include <curl/easy.h>

static char *opt_host_name = "http://%s/py/kms_httpserver.py";
...
//function sets
int kms_init();
int kms_retrieve(char * kms_table, int id, char *data, unsigned int * datalen);
int kms_close();
int kms_request_newid();
#endif
