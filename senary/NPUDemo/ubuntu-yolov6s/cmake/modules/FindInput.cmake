...
find_path(${PKG_NAME}_FOUND_PATH
  ...
  PATH_SUFFIXES libinput/usr/include
)
list(APPEND ${PKG_NAME}_INCLUDE_DIRS ${${PKG_NAME}_FOUND_PATH})

set(LIBS input mtdev)
set(LIBS_SUBDIR libinput mtdev)
list(LENGTH LIBS count)
math(EXPR count "${count} - 1")
foreach(i RANGE ${count})
  list(GET LIBS ${i} lib)
  list(GET LIBS_SUBDIR ${i} subdir)
  find_library(${PKG_NAME}_FOUND_LIB_${i}
    NAMES ${lib}
    PATHS ${CMAKE_FIND_ROOT_PATH}
    PATH_SUFFIXES ${subdir}/usr/lib
  )
  # message("found lib ${subdir} ${lib} at ${${PKG_NAME}_FOUND_LIB_${i}}")
