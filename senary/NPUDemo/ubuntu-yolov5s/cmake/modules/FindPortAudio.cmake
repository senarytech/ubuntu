...
# ////////////////////////////////////////////////////////////////////////////////
#
set(PKG_NAME "PortAudio")

find_path(${PKG_NAME}_FOUND_PATH
  NAMES portaudio.h
  PATHS ${CMAKE_FIND_ROOT_PATH}
  PATH_SUFFIXES portaudio-v19/usr/include
)
list(APPEND ${PKG_NAME}_INCLUDE_DIRS ${${PKG_NAME}_FOUND_PATH})

find_library(${PKG_NAME}_FOUND_LIB
  NAMES portaudio
  PATHS ${CMAKE_FIND_ROOT_PATH}
  PATH_SUFFIXES portaudio-v19/usr/lib
)
list(APPEND ${PKG_NAME}_LIBRARIES ${${PKG_NAME}_FOUND_LIB})
