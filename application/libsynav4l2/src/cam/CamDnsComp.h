...
#ifndef SRC_CAM_CAMDNSCOMP_H_
#define SRC_CAM_CAMDNSCOMP_H_

#include "CamCompIntf.h"

class CamDnsComp : public CamCompIntf {
public:
    CamDnsComp(AMP_FACTORY ampFactory, bool tunnelMode);
    virtual ~CamDnsComp();
