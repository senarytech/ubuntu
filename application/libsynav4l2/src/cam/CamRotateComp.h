...
#ifndef SRC_CAM_CAMROTATECOMP_H_
#define SRC_CAM_CAMROTATECOMP_H_

#include "CamCompIntf.h"

class CamRotateComp : public CamCompIntf {
public:
    CamRotateComp(AMP_FACTORY ampFactory, bool tunnelMode);
    virtual ~CamRotateComp();
...
#endif /* SRC_CAM_CAMROTATECOMP_H_ */
