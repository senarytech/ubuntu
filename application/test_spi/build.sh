...
opt_intermediate_dir=${CONFIG_SYNA_SDK_OUT_TARGET_PATH}/test_spi
...
make all -C ${mod_dir} CC="${cc_name}" E_CFLAG="${cflags}" E_LDFLAG="${CONFIG_TOOLCHAIN_APPLICATION_LDFLAG}" BUILD_DIR="${opt_intermediate_dir}"
