    ...
    try:
       ...
       # uncompress the IMAGES partitions from the target_files zip
        with open(os.devnull) as out:
           ...
           images = ['boot', 'dtbo','vbmeta', 'vbmeta_system', 'recovery']
...
def copy_missing(src_emmc, dst_emmc):
    ...
    files = ['emmc_image_list', 'emmc_part_list', 'emmc_image_list_full', 'userdata.subimg', 'boot-debug.subimg', 'cache.subimg']
