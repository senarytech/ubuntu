These scripts are for the customer to change the OEM keys used to resign OTA/eMMC images for BG5CT, please follow the steps below:
 ...
 1. prepare the keys and stores below that are used to resign Android target file and eMMC image.
    ...
    old oem_custk            : File containing the raw OEM_CUSTK key used to encrypt the images in input target files zip
                               Be aware of this key is same as synaptics-sdk/security/keys/chip/bg5ct/A0/mid-00000007/oem/codetype_5/custk.bin
 ...
 3. For Android A/B (Seamless) update system, please substitute resign_from_target_files_ab.py for resign_from_target_files.py and
    rebuild_emmc_from_target_files_ab.py for rebuild_emmc_from_target_files.py in the following steps.
 ...
 5. Resigning target files and APKs:
 ...
 6. Resigning target files to change the OEM keys:
 ...
 7. Generating a resigned OTA image from the resigned target files:
 ...
 8. Generating an eMMC image from the resigned target files:
