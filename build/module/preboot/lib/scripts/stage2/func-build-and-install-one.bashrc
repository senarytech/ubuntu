...
build_and_install_bootflow_feature() {
  ...
  if [ "is${opt_boot_spi_then_sd}" = "isy" ]; then
    if [ "is${opt_gen_skip}" = "isy" ]; then
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_sd_gen_skip_en.bin
    else
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_sd_en.bin
    fi
  else
    if [ "is${opt_gen_skip}" = "isy" ]; then
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_gen_skip_en.bin
    else
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_en.bin
    fi
  fi
  ...
  if [ "is${opt_boot_spi_then_sd}" = "isy" ]; then
    if [ "is${opt_gen_skip}" = "isy" ]; then
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_sd_gen_skip_en_mp.bin
    else
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_sd_en_mp.bin
    fi
  else
    if [ "is${opt_gen_skip}" = "isy" ]; then
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_gen_skip_en_mp.bin
    else
      INSTALL_F ${preboot_outdir_build_release}/miniloader_en.bin ${preboot_release_topdir}/prebuilts/${preboot_feature_variant}/miniloader_en_mp.bin
    fi
  fi
