...
opt_cross_compile="${CONFIG_SYNA_SDK_PATH}/toolchain/aarch64/gcc-arm-aarch64-linux-gnu-8.3/bin/${CONFIG_TOOLCHAIN_BSP}"
...
if [ "is${CONFIG_BOOT_SPI_THEN_SD}" = "isy" ]; then
  opt_boot_spi_then_sd=y
else
  opt_boot_spi_then_sd=n
fi
