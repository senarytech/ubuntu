...
//Move possible(frame-buffer,etc.) allocation from noncacheable to cacheable,
//to meet fastlogo.ta memory requirement
#define SHM_SHARE_SZ 4*1024*1024
#endif
