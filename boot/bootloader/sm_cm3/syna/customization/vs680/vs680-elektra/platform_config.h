...
/* GPIO */
#define SM_GPIO_VCORE 		20
#define VCORE_ON 		0
#define VCORE_OFF 		1

#define SM_GPIO_VCPU 		17
#define VCPU_ON 		0
#define VCPU_OFF 		1

#define SM_GPIO_VDDM		0
#define VDDM_ON			0
#define VDDM_OFF		1

#define SM_GPIO_VDDM_LPQ	21
...
#define ADC_BTN_SW1_SHORT_PRESS_ACTION_TIME	1000
#define ADC_BTN_SW1_LONG_PRESS_ACTION_TIME	3*1000
#define ADC_BTN_SW2_SHORT_PRESS_ACTION_TIME	100
#define ADC_BTN_SW2_LONG_PRESS_ACTION_TIME	3*1000
#define ADC_BTN_SW3_SHORT_PRESS_ACTION_TIME	100
#define ADC_BTN_SW3_LONG_PRESS_ACTION_TIME	3*1000
#define ADC_BTN_SW4_SHORT_PRESS_ACTION_TIME	100
#define ADC_BTN_SW4_LONG_PRESS_ACTION_TIME	3*1000
#define LONG_PRESS_TIMEOUT			6*1000

/* ADC button IR Key */
#define ADC_BTN_SW1_SHORT_PRESS_KEY	MV_IR_KEY_BEGIN_PAIRING
#define ADC_BTN_SW1_LONG_PRESS_KEY 	MV_IR_KEY_RECOVERY
#define ADC_BTN_SW2_SHORT_PRESS_KEY	MV_IR_KEY_POWER
#define ADC_BTN_SW2_LONG_PRESS_KEY 	MV_IR_KEY_NULL
